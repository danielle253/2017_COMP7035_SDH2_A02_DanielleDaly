...
public class MyMain {
	...
	public static void test(){
		...
		resI = ex.maxInt(m1); //Ans: -1
		System.out.println(resI);
		
		resI = ex.maxInt(m2); //Ans: 9
		System.out.println(resI);		
		
		resI = ex.maxInt(m3); //Ans: 8
		System.out.println(resI);
		...
		resB = ex.isReverse(m1); //True
		System.out.println(resB);
		
		resB = ex.isReverse(m2); //True
		System.out.println(resB);		
		
		resB = ex.isReverse(m3); //False
		System.out.println(resB);		
		...
		resI = ex.power(3, 5); //Ans = 243
		System.out.println(resI);
		
		resI = ex.power(2, 0); //Ans = 1
		System.out.println(resI);		
		
		resI = ex.power(5, 2); //Ans = 25
		System.out.println(resI);
		...
		resI = ex.lucas(0); //Ans: 2
		System.out.println(resI);
		
		resI = ex.lucas(3); //Ans: 4
		System.out.println(resI);

		resI = ex.lucas(15); //Ans: 1364
		System.out.println(resI);
